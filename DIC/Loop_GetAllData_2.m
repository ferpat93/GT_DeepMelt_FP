...
Disp = cell(numel(tests_list),4);
Strain = cell(numel(tests_list),4);
%PV
...
for t = 1:numel(tests_list)
    ...
    for i=1:numel(indexes)   
        if and(table{indexes(i),4}>0,table{indexes(i),5}>0)
            ...
            if i==2
                [Disp{t,i}, Strain{t,i},Disp{t,4}, Strain{t,4}]=get_Images(disp_path,strain_path,DeviceFolder,Disp{t,i-1},Strain{t,i-1});
            else
...
save('Data2.mat','Porosity','Disp','Strain','Volume','Device');
