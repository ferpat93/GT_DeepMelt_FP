...
folder = '/Users/lfp3/Dropbox (GaTech)/GT/Fall_19/HDD-ACO/Case Studies to be evaluated/Franklin Wash/';

ACO = readmatrix(fullfile(folder,'ACO.csv'));
...
plot([0 30],[2254 2254],'Color',[0.8500 0.3250 0.0980]) % Geometric Minimum
plot([0 30],[2269.45 2269.45],'Color',[0 38 154]./255) % Actual Design

ylim([2252 2270])
xlabel('Generation')
ylabel('Total Drill length [ft]')
legend_entries={'Engineered Design','Geometric Minimum','1st and 3rd  Quartiles','Mean Length','Minimum Length'};
...
subplot(2,1,2)
hold on
plot(GS,abs(ACO(:,4)-ACO(:,3)).*(100000/2254),'Color',[0 50 0]./255) % IQR
plot(GS,abs(ACO(:,2)-ACO(:,1)).*(100000/2254),'Color',[0.6350 0.0780 0.1840]) % Mean-Min
