% HDD Test Cases Code - > FixedCenter
close all

folder =  '/Users/lfp3/Dropbox (GaTech)/GT/Previous Semesters/Fall_19/HDD-ACO/Case Studies to be evaluated/FixedCenter/';
...
plotHDD(Long,[0 100],[15 0 60]./255);
