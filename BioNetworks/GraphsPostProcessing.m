...
%}
plot_order=[1 6 5 9];
plot_titles={'Population at walkable distance','Population per km of Network','Population per Buffer area (km2)','Buffer Area per km of Network'};
...
%figure(18)
for p=1:numel(plot_order)
    figure(18+p)
    %subplot(1,numel(plot_order),p); 
    d = Data(plot_order(p),1:3);
