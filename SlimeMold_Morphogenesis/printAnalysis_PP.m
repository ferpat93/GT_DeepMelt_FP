...
% masterArray
load('E:\Slime-Mold-GT-Tolouse\HOMOGENEOUS-ANALYSIS\RESULTS\BufferChoiceData.mat')
Treatments={'Glucose_100mM','Glucose_200mM','Control','NaCl_100mM'};
WF=1;

if WF==1
    excelPath='E:\Slime-Mold-GT-Tolouse\HOMOGENEOUS-ANALYSIS\RESULTS\BufferChoiceData.xls';
...
grapher_path='E:\Slime-Mold-GT-Tolouse\HOMOGENEOUS-ANALYSIS\RESULTS\GrapherChoiceData.xls';
