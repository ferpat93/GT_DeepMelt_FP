...
f{2}='E:\Slime-Mold-GT-Tolouse\SPOT-ANALYSIS\RESULTS\Results-Spot_Glucose_200mM_9_02_R3_ET1\Spot_Glucose_200mM_9_02_R3_ET1-ClassifiedImages.mat';
f{1}='E:\Slime-Mold-GT-Tolouse\SPOT-ANALYSIS\RESULTS\Results-Spot_Glucose_100mM_11_02_R2_ET1\Spot_Glucose_100mM_11_02_R2_ET1-ClassifiedImages.mat';
f{3}='E:\Slime-Mold-GT-Tolouse\SPOT-ANALYSIS\RESULTS\Results-Spot_Glucose_100mM_NaCl_200mM_14_02_R2_ET2\Spot_Glucose_100mM_NaCl_200mM_14_02_R2_ET2-ClassifiedImages.mat';
f{4}='E:\Slime-Mold-GT-Tolouse\SPOT-ANALYSIS\RESULTS\Results-Spot_Glucose_200mM_NaCl_200mM_11_02_R3_ET1\Spot_Glucose_200mM_NaCl_200mM_11_02_R3_ET1-ClassifiedImages.mat';
...
% position = [x y; x+maxRows y; x y+150+maxRows; x+maxRows-100 y+150+maxRows]; 
position = [230 30 ; 1470 30 ; 160 1370 ; 1400 1370]; 
box_color = {'white','white','white','white'};

%Video Parameters
filepathE = fullfile(pwd,'Spot-Joint-Video');
